...
void input(void)
{
	...
	extern int nmaxbc; //added April 2019
	...
	extern float inArtPO2, inCapPO2, inVenPO2, HDin0, outConcErrMax; //added April 2019
	...
	ifp = fopen("BCparams.dat", "r"); // Added BCparams.dat April 2019
	fscanf(ifp, "%i%*[^\n]", &nmaxbc);
	fscanf(ifp, "%f%*[^\n]", &inArtPO2);
	fscanf(ifp, "%f%*[^\n]", &inVenPO2);
	fscanf(ifp, "%f%*[^\n]", &inCapPO2);
